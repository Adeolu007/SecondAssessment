...
public class RentalRepository {
    ...
    public String viewSpecificPropertySubclass(PropertyCode prefix) {
    ...
    public int totalNumberOfSpecifiedPropertySubclass(PropertyCode prefix) {
        int count = 0;
        for (int i = 0; i < properties.length; i++) {
            if (properties[i] != null && properties[i].getPrefix().equals(prefix)) {
                count++;
    ...
    public int totalNumberOfBedroomsInSpecifiedPropertySubclass(PropertyCode prefix) {
        int count = 0;
        for (Property property : properties) {
    ...
    public int totalNumber0fBathroomsInSpecifiedPropertySubclass(PropertyCode prefix) {
        int count = 0;
        for (Property property : properties) {
    ...
    public Double totalRentalIncomeForSpecifiedPropertySubclass(PropertyCode prefix) {
        double count = 0;
        for (Property property : properties) {
    ...
    public int totalNumberOfOccupiedPropertiesInSpecifiedPropertySubclass(PropertyCode prefix) {
        int count = 0;
        for (Property property : properties) {
    ...
    public int totalNumberOfUnoccupiedPropertiesInSpecifiedPropertySubclass(PropertyCode prefix) {
        int count = 0;
        for (Property property : properties) {
            if (property != null && property.getPrefix().equals(prefix) && !property.isOccupiedStatus()) count++;
        }
    ...
    public String toString(PropertyCode prefix) {
